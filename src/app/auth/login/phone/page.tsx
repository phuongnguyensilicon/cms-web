...
export default function UserLoginPhonePage() {
  ...
  const onNext = () => {
    if (isValidPhoneNumber(sms)) {
      UserService.getCode({ sms }, setData, setError, setLoading);
    }
  };
  ...
  return (
    <section className="user-phone">
      ...
      <h1>{data ? 'Check your SMS' : 'Login with Phone'}</h1>
